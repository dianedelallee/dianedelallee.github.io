...
__export(index_exports, {
  ...
  getKeyValue: () => import_shared_utils11.getKeyValue,
  useTable: () => useTable
});
...
// src/index.ts
var import_shared_utils11 = require("@heroui/shared-utils");

// src/table.tsx
var import_react8 = require("react");
var import_spacer2 = require("@heroui/spacer");
var import_system11 = require("@heroui/system");
...
var TableRowGroup = (0, import_react3.forwardRef)((props, ref) => {
  var _a;
...
var TableColumnHeader = (0, import_system3.forwardRef)((props, ref) => {
  var _a, _b, _c, _d, _e;
...
var TableRow = (0, import_system5.forwardRef)((props, ref) => {
  ...
  const { isFirst, isLast, isMiddle, isOdd } = (0, import_react4.useMemo)(() => {
...
var TableCell = (0, import_system6.forwardRef)((props, ref) => {
  ...
  const cell = (0, import_react5.useMemo)(() => {
...
var TableCheckboxCell = (0, import_system7.forwardRef)((props, ref) => {
  var _a, _b;
  const {
    as,
    className,
...
var VirtualizedTable = (0, import_system9.forwardRef)((props, ref) => {
  const {
    BaseComponent,
    Component,
    collection,
  ...
  const [headerHeight, setHeaderHeight] = (0, import_react6.useState)(0);
    ...
    /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(Wrapper, { children: /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)(import_jsx_runtime9.Fragment, { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)(
        Component,
        {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)(table_row_group_default, { ref: headerRef, classNames: values.classNames, slots: values.slots, children: [
...
var import_react_utils11 = require("@heroui/react-utils");
var import_shared_utils10 = require("@heroui/shared-utils");
var import_table11 = require("@react-aria/table");
var import_react_utils12 = require("@heroui/react-utils");
...
var TableBody = (0, import_system10.forwardRef)((props, ref) => {
  ...
  const Component = as || "tbody";
  const shouldFilterDOMProps = typeof Component === "string";
  const domRef = (0, import_react_utils11.useDOMRef)(ref);
  const { rowGroupProps } = (0, import_table11.useTableRowGroup)();
  const tbodyStyles = (0, import_shared_utils10.clsx)(classNames == null ? void 0 : classNames.tbody, className);
  const bodyProps = collection == null ? void 0 : collection.body.props;
  const isLoading = (bodyProps == null ? void 0 : bodyProps.isLoading) || (bodyProps == null ? void 0 : bodyProps.loadingState) === "loading" || (bodyProps == null ? void 0 : bodyProps.loadingState) === "loadingMore";
  const renderRows = (0, import_react7.useMemo)(() => {
    return [...collection.body.childNodes].map((row) => /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
      table_row_default,
      {
        classNames,
        isSelectable,
        ...
        state,
        children: [...row.childNodes].map(
          (cell) => cell.props.isSelectionCell ? /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
            table_checkbox_cell_default,
            {
              checkboxesProps,
              classNames,
  ...
  let loadingContent;
  if (collection.size === 0 && bodyProps.emptyContent) {
    emptyContent = /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("tr", { role: "row", children: /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
      "td",
      {
        className: slots == null ? void 0 : slots.emptyWrapper({ class: classNames == null ? void 0 : classNames.emptyWrapper }),
        colSpan: collection.columnCount,
  ...
  if (isLoading && bodyProps.loadingContent) {
    loadingContent = /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("tr", { role: "row", children: [
      /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
        "td",
        {
          className: slots == null ? void 0 : slots.loadingWrapper({ class: classNames == null ? void 0 : classNames.loadingWrapper }),
      ...
      !emptyContent && collection.size === 0 ? /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("td", { className: slots == null ? void 0 : slots.emptyWrapper({ class: classNames == null ? void 0 : classNames.emptyWrapper }) }) : null
    ] });
  }
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)(
    ...
    {
      ref: domRef,
      ...(0, import_utils10.mergeProps)(
        rowGroupProps,
        (0, import_react_utils12.filterDOMProps)(bodyProps, {
          enabled: shouldFilterDOMProps
        }),
        otherProps
      ),
      className: (_a = slots.tbody) == null ? void 0 : _a.call(slots, { class: tbodyStyles }),
      "data-empty": (0, import_shared_utils10.dataAttr)(collection.size === 0),
      "data-loading": (0, import_shared_utils10.dataAttr)(isLoading),
      children: [
        renderRows,
        loadingContent,
        emptyContent
...
var Table = (0, import_system11.forwardRef)((props, ref) => {
  const {
    BaseComponent,
    Component,
    collection,
  ...
  const Wrapper = (0, import_react8.useCallback)(
    ({ children }) => {
      if (removeWrapper) {
        return children;
      }
      return /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(BaseComponent, { ...getWrapperProps(), children });
    },
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { ...getBaseProps(), children: [
    topContentPlacement === "outside" && topContent,
    /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(Wrapper, { children: /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)(import_jsx_runtime11.Fragment, { children: [
      topContentPlacement === "inside" && topContent,
      /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)(Component, { ...getTableProps(), children: [
        /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)(table_row_group_default, { classNames: values.classNames, slots: values.slots, children: [
          collection.headerRows.map((headerRow) => /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
            table_header_row_default,
            {
              classNames: values.classNames,
              node: headerRow,
              ...
              children: [...headerRow.childNodes].map(
                (column) => {
                  var _a;
                  return ((_a = column == null ? void 0 : column.props) == null ? void 0 : _a.isSelectionCell) ? /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
                    table_select_all_checkbox_default,
                    {
                      checkboxesProps: values.checkboxesProps,
                      classNames: values.classNames,
          ...
          /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(import_spacer2.Spacer, { as: "tr", tabIndex: -1, y: 1 })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
          table_body_default,
          {
